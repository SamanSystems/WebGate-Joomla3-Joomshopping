...
class pm_zarinpal extends PaymentRoot
{
    ...
    function showEndForm($pmconfigs, $order)
    {
        ...
        $result_url = JURI::root() . "index.php?option=com_jshopping&amp;controller=checkout&amp;task=step7&amp;act=notify&amp;js_paymentclass=pm_zarinpal&amp;no_lang=1&amp;order_id=".$order->order_id;
        $success_url = JURI::root(). "index.php?option=com_jshopping&amp;controller=checkout&amp;task=step7&amp;act=return&amp;js_paymentclass=pm_zarinpal";
        $fail_url = JURI::root() . "index.php?option=com_jshopping&amp;controller=checkout&amp;task=step7&amp;act=cancel&amp;js_paymentclass=pm_zarinpal";
        $params = array();
        ...
        $html .= '<form id="paymentform" method="POST" action="https://de.zarinpal.com/pg/services/WebGate/wsdl">';
	    ...
	    $html .= '<input type="submit" value="'.MONEXY_PAY.'">';
        $html .= '</form>';
        echo($html);
