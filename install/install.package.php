<?php
  ...
  function com_install()
  {
	...
	$source=JPATH_ADMINISTRATOR . "/components/com_joominajszarinpal/js/pm_zarinpal/";
    $destination=JPATH_SITE . "/components/com_jshopping/payments/pm_zarinpal/";
	$path=JPATH_ADMINISTRATOR . "/components/com_joominajszarinpal/";
