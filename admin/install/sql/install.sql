...
DELETE FROM `#__jshopping_payment_method` WHERE `payment_code` = 'zarinpal';
...
(NULL, 'zarinpal','zarinpal', '', '', 'zarinpal','pm_zarinpal', 0, 5, 'acc=joomina\n transaction_end_status=6\n transaction_pending_status=1\n transaction_failed_status=3\n checkdatareturn=0', 2, 1, 0, 0,'zarinpal', '');
